...
public class IndexSimpleVerifier extends SimpleVerifier {
	...
	protected boolean isInterface(Type type) {
		AccessFlags classAccess = this.entryIndex.getClass(type.getInternalName()).getAccess();
		if (classAccess != null) {
	...
	protected Type getSuperClass(Type type) {
		ClassEntry entry = this.entryIndex.getClass(type.getInternalName());
		if (entry != null) {
			return Type.getType('L' + entry.getDefinition().getSuperClass().getFullName() + ';');
		}
